...
execute as @p[advancements={custom:picklock_iron_door=true}] at @s if entity @e[tag=picklock_iron_door,distance=..2] store result score @s results run loot spawn ~ ~ ~ loot custom:random/picklock_iron_door
